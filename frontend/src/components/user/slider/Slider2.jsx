...
const slidesData = [
  {
    url: "https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/store-card-40-accessories-story-202509?wid=800&hei=1000&fmt=p-jpg&qlt=95&.v=K1NBYnFSRndoRHEyUklJLyttMlQ2TDJZSWVLNGdhSUJlSmNGa21DNVh4dllGV1BtVDBLaVpxMVJKZEI3MFYwYnN2Mmx4a3VvSnUzaFUvSVlVRUJkbEdmUjhFNHFyZ0hQbWZocUNqTGJDcWpMZyt1a0tPOGRUTGk5YmUzdUpPZGo",
    name: "iPhone 17 Pro",
    des: "Pro đỉnh cao.",
    tag: "Đặt trước ngay",
    price: "Từ 34.990.000₫",
...
<Swiper
   ...
   >
     ...
     >
       ...
       <h2 className={`text-3xl font-sf ${index === 0 ? "text-black" : "text-black"}`}>
         {item.name}
       </h2>
       <p className={`text-lg font-sf ${index === 0 ? "text-black" : "text-black"}`}>
         {item.des}
       </p>
       <p className={`text-sm ${index === 0 ? "text-black" : "text-black"}`}>
         {item.price}
       </p>
     </div>
   </SwiperSlide>
